...
urlpatterns = [
    path('inicio', views.employe_list , name='inicio'),
    path('', views.CustomLoginView.as_view(template_name='registration/login.html') , name='login'),
    path('modificar/<pk>/', views.EmpleadoUpdate.as_view() , name='empleado-update'),
    ...
    path('modificar/<pk>/', views.ProveedorUpdate.as_view() , name='proveedor-update'),
